...
ob1_com_port =str("COM8") #COM port to which OB1 is connected to. Refer to Elveflow SDK userguide for this!
...
def save_image_8bit_as():
    ...
    filename_img = 'image_mono.tiff'
    camera = asi.Camera(0)
    camera.set_roi(start_x=None, start_y=None, width=4096, height=4096, bins=None, image_type=None)
    camera.set_control_value(asi.ASI_GAIN, 600) # Change accordingly
    camera.set_control_value(asi.ASI_EXPOSURE, 600*1000) # Change accordingly (x*1000= x000 micro sec.)
    camera.set_control_value(asi.ASI_WB_B, 99) # Change accordingly
    camera.set_control_value(asi.ASI_WB_R, 75) # Change accordingly
...
def save_image_16bit_as():
    ...
    camera.set_control_value(asi.ASI_EXPOSURE, 800*1000) # Change accordingly (x*1000= x000 micro sec.)
    camera.set_control_value(asi.ASI_WB_B, 99) # Change accordingly
    camera.set_control_value(asi.ASI_WB_R, 75) # Change accordingly
    camera.set_control_value(asi.ASI_GAMMA, 50) # Change accordingly
    camera.set_control_value(asi.ASI_BRIGHTNESS,0) # Change accordingly
